...
// Initialize the Google Cloud Vision client -- switched to use google's vision api instead of openai's vision api
const client = new ImageAnnotatorClient({
  keyFilename: process.env.GOOGLE_CLOUD_CREDENTIALS_PATH || './google-credentials.json',
